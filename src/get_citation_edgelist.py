...
def load_token(token_file: str = "token.json") -> dict:
    try:
...
def main():
    ...
    for edge in all_edges:
        ...
        if origin_doi in repo_dict and target_doi in repo_dict:
            # Fill missing sub-area information from our repository dictionary.
    ...
    print(
        f"[SUMMARY] Total citation/reference edges after filtering: {len(filtered_edges)}"
    )
    ...
    output_file = "citations_edge_list_repo_only.csv"
